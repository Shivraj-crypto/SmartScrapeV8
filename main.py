...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Fetch a URL with Scrapling and return cleaned HTML and readable text."
    )
    parser.add_argument(
        "url",
        nargs="?",
...
async def run(url: str, save_html: str | None, save_text: str | None) -> int:
...
def main() -> int:
    ...
    try:
        return asyncio.run(
            run(url=url, save_html=args.save_html, save_text=args.save_text)
        )
